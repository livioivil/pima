...
library(rpart)
library(rpart.plot)
pima_tree(res=res1) # raw pvalues
...
In the selected model the adjusted effect of the masfem variable is significant. 1-point increase in masfem variables implies an increase of the risk of death of 19.47%.