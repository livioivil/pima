...
#' @usage global_tests(obj, by = NULL, comb_funct = "maxT") 
...
#' @details This function builds on the function \code{combine} of the \strong{jointest} package.
...
global_tests <- function(obj, by = NULL, comb_funct = "maxT"){
